...
export default function ColaDespacho() {
  ...
  const load = async () => {
    ...
    setOrdenes((data || []).filter(o =>
      ['CONFIRMADA', 'PROGRAMADA'].includes(o.estado)
    ));
  };
      ...
      <div className="page">
        ...
        <div className="card" style={{ marginBottom: 16 }}>
          ...
          <div style={{ fontSize: 12, color: 'var(--text2)' }}>
            {despachando.fechaDespacho ? `Despacho: ${despachando.fechaDespacho}` : despachando.fecha}
          </div>
        </div>
  ...
  return (
    <div className="page">
      <h1 className="page-title">Cola de despacho</h1>

      {ordenes.length === 0 && !loading && (
        <p className="empty">Sin órdenes pendientes de despacho</p>
      )}
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 12 }}>
              <div>
                ...
                <div style={{ fontSize: 12, color: 'var(--text2)', marginTop: 2 }}>
                  {o.fechaDespacho ? `Despacho: ${o.fechaDespacho}` : `Fecha: ${o.fecha}`}
                </div>
